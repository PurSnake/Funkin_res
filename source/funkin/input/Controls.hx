...
class Controls extends FlxActionSet
{
	...
	var _volume_upP = new FunkinAction(Action.VOLUME_UP_P);
	var _volume_down = new FunkinAction(Action.VOLUME_DOWN);
	var _volume_downP = new FunkinAction(Action.VOLUME_DOWN_P);
	...
	inline function get_VOLUME_UP()
		return _volume_up.checkPressed();

	public var VOLUME_UP_P(get, never):Bool;
	inline function get_VOLUME_UP_P()
		return _volume_up.checkJustPressed();

	public var VOLUME_DOWN(get, never):Bool;
	inline function get_VOLUME_DOWN()
		return _volume_down.checkPressed();

	public var VOLUME_DOWN_P(get, never):Bool;
	inline function get_VOLUME_DOWN_P()
		return _volume_down.checkJustPressed();
	...
	function forEachBound(control:Control, func:FlxActionDigital->FlxInputState->Void)
	{
		switch(control)
		{
			...
			case VOLUME_UP:
				func(_volume_up, PRESSED);
				func(_volume_up, JUST_PRESSED);
			case VOLUME_DOWN:
				func(_volume_down, PRESSED);
...
enum abstract Action(String) to String from String
{
	...
	var VOLUME_UP_P = "volume_up-press";
	var VOLUME_DOWN = "volume_down";
	var VOLUME_DOWN_P = "volume_down-press";
