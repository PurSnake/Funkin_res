...
class Constants
{
	 ...
	 */
	public static final TITLE:String = "Friday Night Funkin': Grafex";
	...
	public static var defaultThemeTrack:String = "freakyMenu";
	 ...
	 */
	public static final STRUMLINE_X_OFFSET:Float = 96; //48
	 ...
	 */
	public static final DEFAULT_CAMERA_FOLLOW_RATE:Float = 0.04; //source/funkin/play/GameOverSubState.hx:175: characters 59-85
}
